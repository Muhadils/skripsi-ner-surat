...
def main():
    ...
    training_args = TrainingArguments(output_dir="./results_nik", num_train_epochs=10, per_device_train_batch_size=8, evaluation_strategy="epoch", learning_rate=3e-5, save_strategy="no", use_cpu=True)
